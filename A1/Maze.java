...
public class Maze {
    ...
    public Maze(File file){
        getMaze(file);
        fillMaze();
        this.startNode = maze[startNodeNumber/coloum][startNodeNumber%coloum -1];
        this.finishNode = maze[finishNodeNumber/coloum][finishNodeNumber%coloum -1];
        setNodeValues();
        connectMaze();
    }
    ...
    public String toString(){
        String mazeString = "";
        mazeString += row + ":" + coloum + ":"+ startNode + ":" + finishNode + ":" + nodeList + "\n";
        return mazeString;
    }
